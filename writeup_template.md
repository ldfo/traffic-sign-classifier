...
| Conv2D  		     	| 1x1 stride, VALID padding, outputs 32x32x16 	|
| RELU					|												|
| Max pooling	      	| 2x2 stride,  outputs 16x16x16, padding Valid	|
| Conv2D			    | 1x1 stride,  outputs 16x16x8, padding Valid	|
| RELU 					| 												|
| Max pooling			| 2x2 stride,  outputs 8x8x8					|
